...
=============================================================
 ...
 v9 : option rapide — ε_gel=8kBT, t_final=500τ, N=300
...
DT         = 5e-5
N_EQUIL    = 8_000
N_STEPS    = 10_000_000  # t_final = 500 τ
SNAP_EVERY = 1_000_000   # 11 snapshots (t=0..500)
...
MSD_EVERY  = 100_000                     # record MSD every N steps
